  ...
  return (
    <section id="hero" className="pt-24 sm:pt-28 pb-6 px-3 sm:px-4 relative z-10">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Main hero card */}
        <div className="rounded-3xl sm:rounded-4xl bg-card border border-border overflow-hidden animate-scale-in relative group">
          {/* Beige gradient hover glow */}
          <div
            className="absolute inset-0 rounded-3xl sm:rounded-4xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"
            style={{ background: "linear-gradient(135deg, hsl(36,30%,95%) 0%, hsl(30,25%,90%) 100%)" }}
          />
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div
              ...
              style={{ background: "linear-gradient(135deg, hsl(36,25%,93%) 0%, hsl(36,20%,88%) 100%)" }}
            >
              {/* Animated concentric rings — beige tinted */}
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    ...
                    style={{
                      width: `${i * 64}px`,
                      height: `${i * 64}px`,
                      border: `1px solid hsl(36, 20%, ${70 - i * 5}%)`,
              ...
              <div className="relative z-10 flex flex-col items-center gap-3">
                <div
                  className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-foreground text-background flex items-center justify-center text-xl sm:text-2xl font-bold font-sans tracking-tight shadow-2xl"
